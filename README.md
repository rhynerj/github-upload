...
This repository stores files for the a project that implements and evaluates the k-means algorithm. It was originally created as the final project in a Mathematics of Data Models course.
This repository includes:
* a Python script with:
    * code for extracting and cleaning a genetic and a numerical dataset
    * principal component analysis to reduce data dimensonality
    * a custom-engineered k-means algorithm to conduct unsupervised machine learning on data
    * code for visualizations of results
* final report interpreting results
* a Jupyter Notebook with all code, results, and analysis
* a file with various tests run during development

## K-means.py Imprementation Instructions
